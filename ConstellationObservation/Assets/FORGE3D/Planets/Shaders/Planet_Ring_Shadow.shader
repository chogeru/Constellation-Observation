...
Shader "FORGE3D/Planets HD/Ring Shadow"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_DetailMap("Detail Map", 2D) = "white" {}
		_RingSize("Ring Size", Float) = 0
		_RingOffset("Ring Offset", Float) = 0
		[ASEEnd]_Clip("Clip", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float4 appendResult18 = (float4(( ( length( IN.ase_texcoord3.xyz ) - temp_output_14_0 ) / ( _RingSize - temp_output_14_0 ) ) , 0.5 , 0.0 , 0.0));
				float4 tex2DNode1 = tex2D( _DetailMap, appendResult18.xy );
				float temp_output_121_0 = saturate( ( tex2DNode1.a * _Clip ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float temp_output_14_0 = ( _RingOffset + 1.0 );
				float4 appendResult18 = (float4(( ( length( IN.ase_texcoord2.xyz ) - temp_output_14_0 ) / ( _RingSize - temp_output_14_0 ) ) , 0.5 , 0.0 , 0.0));
				float4 tex2DNode1 = tex2D( _DetailMap, appendResult18.xy );
				float temp_output_121_0 = saturate( ( tex2DNode1.a * _Clip ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float temp_output_14_0 = ( _RingOffset + 1.0 );
				float4 appendResult18 = (float4(( ( length( IN.ase_texcoord.xyz ) - temp_output_14_0 ) / ( _RingSize - temp_output_14_0 ) ) , 0.5 , 0.0 , 0.0));
				float4 tex2DNode1 = tex2D( _DetailMap, appendResult18.xy );
				float temp_output_121_0 = saturate( ( tex2DNode1.a * _Clip ) );
		...
		Pass
		{
				 ...
				 )
			{
				...
				float temp_output_14_0 = ( _RingOffset + 1.0 );
				float4 appendResult18 = (float4(( ( length( IN.ase_texcoord1.xyz ) - temp_output_14_0 ) / ( _RingSize - temp_output_14_0 ) ) , 0.5 , 0.0 , 0.0));
				float4 tex2DNode1 = tex2D( _DetailMap, appendResult18.xy );
				float temp_output_121_0 = saturate( ( tex2DNode1.a * _Clip ) );
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-2004.199,-333.6001;Float;False;Property;_RingOffset;Ring Offset;2;0;Create;True;0;0;0;False;0;False;0;7.89;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;3;-1841.2,-213.6001;Float;False;Property;_RingSize;Ring Size;1;0;Create;True;0;0;0;False;0;False;0;5.99;0;0;0;1;FLOAT;0
