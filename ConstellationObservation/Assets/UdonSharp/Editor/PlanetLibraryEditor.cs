...
{
    /// <summary>
    /// Shows each planet's name, transform, highlight light, and narration clip on one row.
    /// </summary>
    [CustomEditor(typeof(PlanetLibrary))]
    public class PlanetLibraryEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.LabelField("Planets (presentation order)", EditorStyles.boldLabel);
